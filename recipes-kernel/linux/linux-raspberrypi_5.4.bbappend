SUMMARY = "This is the Xenomai enabled kernel running in the DELIA OS"
DESCRIPTION = "This recipe is taken from https://github.com/s-vincent/meta-raspberrypi-rt-sv.git"
HOMEPAGE = "https://github.com/Melbourne-Instruments/meta-raspberrypi-delia"
...
SRC_URI_append = "\
    file://1.patch \
    file://git/arch/arm/boot/dts/overlays/melbinst-delia-overlay.dts \
